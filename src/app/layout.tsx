  ...
  return (
    ...
    >
      <head>
        ...
        <Script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-X8HJ98GLDS"
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-KZW3GSRG');`,
          }}
        />
      </head>
      <body className="font-inter bg-white overflow-x-hidden" suppressHydrationWarning={true}>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-KZW3GSRG"
            height="0"
            width="0"
